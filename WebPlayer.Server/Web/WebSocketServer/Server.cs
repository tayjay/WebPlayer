    ...
    public partial class Server
    {
        ...
        private void connectionCallback(IAsyncResult AsyncResult)
        {
            try
            {
                ...
                byte[] handshakeBuffer = new byte[WebPlayerPlugin.Instance.Config.WsBufferSize];
                ...
                /*if(headers.ContainsKey("Method"))
                    Logger.Info("Method: " + headers["Method"]);*/
            ...
            {
                Logger.Error($"An error has occured while trying to accept a connecting client.\n\n{Exception.Message}");
            }
        }
        ...
        private bool ValidateApiKey(string apiKey)
        {
            ...
            return apiKey.Equals(WebPlayerPlugin.Instance.Config?.ApiKey); // Example validation
        }
